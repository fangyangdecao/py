...
def check_play_key(ai_settings, screen, stats, ship, aliens, bullets):
    """在玩家单击Play按钮时开始新游戏"""
...
def check_keydown_events(event, ai_settings, screen, stats, ship, aliens, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        check_play_key(ai_settings, screen, stats, ship, aliens, bullets)
